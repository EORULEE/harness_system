...
- **포함**: 45 스킬(dev-discipline·code-claim 게이트·loop·deep-interview·ralph·writing·adaptive·**LLM Wiki** 등) + 13 훅 + 11 smoke + **verification-gate v1.1**(근거 없는 단정 차단 — `docs/VGATE.md`, 기본 report 모드). 코어는 계정 0으로 작동.
